...
@endif
        ...
        <form role="form"  action="{{route('autores.update', $autor->codigo_autor)}}" method="POST">
            ...
            <div class="form-group">
                <label for="codigo_autor">Codigo del autor:</label>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" name="nombre_autor" id="nombre_autor" value="{{old('nombre_autor',$autor->nombtr_autor)}}"  placeholder="Ingresa el nombre del autor" >
                    <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                </div>
            </div>
            <div class="form-group">
